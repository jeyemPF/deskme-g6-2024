...
const stats = [
  ...
  { id: 2, name: 'Market Value | Deskme', value: '$10 million' },
  ...
  <div className='bg-neutral-50 dark:bg-neutral-900'>
    <div className='container'>
      <Navbar/>
          <div className='flex flex-col xl:flex-row items-center'>
            <div className='w-full md:w-2/4y'>
              <h1 className='text-2xl xl:ml-32 xl:text-left sm:text-center sm:text-base sm:pt-12 sm:ml-0'>
                <span className='text-5xl text-neutral-800 font-extrabold leading-8 lg:text-4xl md:text-3xl sm:text-2xl dark:text-white'>Make every <i><span className='font-black text-neutral-800 dark:text-white'>click count.</span></i></span>
                <p className='font-normal text-neutral-700 pt-2 leading-5 lg:text-base md:text-base sm:text-xs dark:text-neutral-300'>
            ...
            <div className='flex items-center justify-center'>
              <div className='flex gap-4 mr-28'>
                <div className='pt-28'>
                  <img className='hidden xl:block lg:h-80 lg:w-96 rounded-xl border-[1px] border-neutral-700 shadow-md transition duration-300 transform hover:scale-105 dark:border-neutral-300' src={desk1} alt="Desk 1"/>
                </div>
                <div className='pt-16'>
                  <img className='hidden xl:block lg:h-80 lg:w-96 rounded-xl border-[1px] border-neutral-700 shadow-md transition duration-300 transform hover:scale-105 dark:border-neutral-300' src={desk2} alt="Desk 2"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <span class="relative z-10 bg-neutral-50 dark:bg-neutral-900 dark:text-white px-6">Reasons & Gallery</span>
          </span>

          <div className='container'>
            <div className='text-center'>
              <div className='text-3xl font-black pt-12 pb-3'>
                <h1 className='text-neutral-700 dark:text-white'>Reasons to choose Deskme</h1>
              </div>

              <div className='text-base pb-12 font-normal text-neutral-700 dark:text-neutral-300'>
              ...
              <div className='flex justify-center pb-10 md:flex-row sm:flex-col sm:items-center md:space-y-0 sm:space-y-4 xl:gap-28 lg:gap-10 md:gap-5'>
                <div className='flex flex-col justify-center items-center box-border h-64 w-64 p-4 border-[1px] rounded-xl text-neutral-700 border-neutral-700 shadow-lg dark:text-neutral-300 dark:border-neutral-300'>
                  <div className='text-7xl transition duration-300 transform hover:scale-105'><PiRocketFill /></div>
                  <div className='text-xl font-bold p-3 text-black-700 dark:text-white'>24/7 Online</div>
                ...
                <div className='flex flex-col justify-center items-center box-border h-64 w-64 p-4 border-[1px] rounded-xl text-neutral-700 border-neutral-700 shadow-lg dark:text-neutral-300 dark:border-neutral-300'>
                  ...
                  <div className='text-xl font-bold p-3 text-black-700 dark:text-white'>Fast Booking</div>
                ...
                <div className='flex flex-col justify-center items-center box-border h-64 w-64 p-4 border-[1px] rounded-xl text-neutral-700 border-neutral-700 shadow-lg dark:text-neutral-300 dark:border-neutral-300'>
                  ...
                  <div className='text-xl font-bold p-3 text-black-700 dark:text-white'>Cloud Storage</div>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:p-36 sm:p-0">
            <div className="grid gap-4">
              <div>
                <img
                  className="h-auto max-w-full rounded-lg object-cover object-center border-[1px] border-neutral-700 dark:border-neutral-300 transition duration-300 transform hover:scale-105"
          ...
          <span class="relative z-10 bg-neutral-50 dark:bg-neutral-900 dark:text-white px-6">Statistics & FAQs</span>
          </span>

          <div className='container'>
            <div className="pt-10 pb-10 mt-5 mx-auto max-w-6xl px-6 lg:px-8">
              <dl className="grid grid-cols-1 gap-y-16 text-center lg:grid-cols-3">
                {stats.map((stat) => (
                  <div key={stat.id} className="mx-auto flex max-w-xs flex-col gap-y-1 bg-neutral-50 border-[1px] border-neutral-700 p-6 rounded-lg shadow-md dark:bg-white">
                    <dt className="text-base leading-7 text-neutral-700 dark:text-neutral-700">{stat.name}</dt>
                    <dd className="order-first text-2xl font-semibold tracking-tight text-neutral-700 dark:text-neutral-700 sm:text-4xl">
                      {stat.value}
                    </dd>
                  </div>
                ))}
          ...
          <div className='container'>
            <div className="py-14">
              <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                  <h3 className="font-semibold text-sm text-neutral-700 dark:text-neutral-100 text-center">
                  ...
                  <div className="mt-6">
                      <ul className="flex gap-x-10 gap-y-6 flex-wrap items-center justify-center md:gap-x-16">
                          {/* LOGO 1 */}
                        <li>
                          <svg className="w-28 dark:bg-white rounded-lg p-2" viewBox="0 0 163 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {/* LOGO 2 */}
                        <li>
                          <svg className="w-28 dark:bg-white rounded-lg p-2" viewBox="0 0 129 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {/* LOGO 3 */}
                        <li>
                          <svg className="w-28 dark:bg-white rounded-lg p-2" viewBox="0 0 135 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {/* LOGO 4 */}
                        <li>
                          <svg className="w-28 dark:bg-white rounded-lg p-2" viewBox="0 0 164 48" fill="none" xmlns="http://www.w3.org/2000/svg">
