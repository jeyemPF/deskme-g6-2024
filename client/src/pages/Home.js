...
const plans = [
  {
      name: "Basic plan",
      desc: "Includes the basic needs you'll need to.",
      price: 5,
      isMostPop: false,
      features: [
          "Booking",
  ...
  {
      name: "Startup",
      desc: "Includes the basic and advanced features you can have.",
      price: 25,
      isMostPop: true,
      features: [
          "Booking",
  ...
  {
      name: "Enterprise",
      desc: "Includes all the necessary things and features you'll need.",
      price: 50,
      isMostPop: false,
      features: [
          "Booking",
...
return (
  ...
  <div className='bg-neutral-50 dark:bg-neutral-900'>
    ...
    <div className=''>
          ...
          <div className="bg-neutral-100 dark:bg-neutral-800" ref={containerRef}>
            <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-start justify-between text-white dark:text-neutral-900 sm:items-center md:px-8">
              <div className="flex-1 justify-center flex items-start gap-x-4 sm:items-center">
                <div className="flex-none p-1.5 px-4 rounded-full bg-neutral-800 dark:bg-neutral-100 flex items-center justify-center font-medium text-sm">
                  Update
                </div>
                <p className="font-normal p-2 text-neutral-700 dark:text-neutral-200">
                  We just launched a new version of our system!{' '}
                  <a href="javascript:(0)" className="font-normal underline duration-150 hover:text-neutral-500 inline-flex items-center gap-x-1">
                    Learn more
                    <svg
              ...
              <button className="p-2 rounded-lg duration-150 text-neutral-700 dark:text-neutral-200" onClick={handleRemove}>
          ...
          <section className="bg-neutral-50 dark:bg-neutral-900 pt-8">
            <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-[450px] lg:items-center">
              <div className="mx-auto max-w-xl text-center">
                <h1 className="text-3xl font-extrabold sm:text-5xl dark:text-neutral-300">
                  Understand User Flow.
                  <strong className="font-extrabold text-neutral-500 sm:block"> Increase Conversion. </strong>
                </h1>

                <p className="mt-4 lg:text-base sm:text-xl/relaxed dark:text-neutral-300">
                  Deskme is built to elevate individuals, providing a seamless <br /> intersection where booking meets brilliance,  empowering users <br /> to thrive through the power of connection and convenience.
                </p>
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-4">
                  ...
                  <button
                    className="block w-full rounded px-12 py-3 text-sm font-medium text-neutral-600 dark:text-neutral-300 border-[1px] border-neutral-300 shadow blue:text-red-700 focus:outline-none sm:w-auto"
                    href="#"
                  >
                    Learn More
                  </button>
                  <div className="flex justify-center items-center gap-x-4 text-gray-400 text-sm">
                    ...
                    <p><span className="text-gray-500">5.0</span> by over 1000 users</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center gap-10 pb-10 flex-wrap xs:flex-col text-neutral-700 dark:text-neutral-300">
            <div className="flex items-center mb-10 sm:mb-3 md:mb-10 xs:w-full xs:text-center">
              ...
              <p className="text-xl xs:text-base xs:block xs:mx-auto sm:text-base">|</p>
              <p className="ml-2 text-base sm:text-base xs:text-sm font-normal xs:mx-auto">Security</p>
            </div>
            <div className="flex items-center mb-10 sm:mb-3 md:mb-10 xs:w-full xs:text-center">
              <p className="p-2 text-2xl xs:text-xl"><PiUsersThreeBold /></p>
              <p className="text-xl xs:text-base xs:block xs:mx-auto sm:text-base">|</p>
              <p className="ml-2 text-base sm:text-base xs:text-sm font-normal xs:mx-auto">Friendly</p>
            </div>
            <div className="flex items-center sm:mb-3 md:mb-10 xs:w-full xs:text-center">
              ...
              <p className="text-xl xs:text-base xs:block xs:mx-auto sm:text-base">|</p>
              <p className="ml-2 text-base sm:text-base xs:text-sm font-normal xs:mx-auto">Privacy</p>
            </div>
            <div className="flex items-center sm:mb-3 md:mb-10 xs:w-full xs:text-center">
              <p className="p-2 text-2xl xs:text-xl"><TbClockPlus /></p>
              <p className="text-xl xs:text-base xs:block xs:mx-auto sm:text-base">|</p>
              <p className="ml-2 text-base sm:text-base xs:text-sm font-normal xs:mx-auto">Efficient</p>
            </div>
          </div>
          ...
          <span class="relative z-10 bg-neutral-50 dark:bg-neutral-900 dark:text-white px-6">About</span>
          </span>

          <div className='bg-neutral-50 sm:p-2 dark:bg-neutral-900'>
            <div className='text-center'>
              <div className='text-3xl font-black pt-12 pb-3 sm:text-4xl'>
                <h1 className='text-neutral-900 dark:text-neutral-200'>Reasons to choose Deskme:</h1>
              </div>

              <div className='text-xl pb-12 font-normal text-neutral-700 dark:text-neutral-300'>
                  <h1>Where booking becomes a breeze! Your easy pass to hassle-free reservations. Swift, seamless, and stress-free!</h1>
              </div>
              ...
              <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                  <div className="max-w-3xl mx-auto text-center">
                        <div className="max-w-xl sm:text-center md:mx-auto">
                          <h3 className="text-gray-800 dark:text-neutral-200 lg:text-2xl font-semibold sm:text-4xl mb-5">
                             See what others saying about us:
                          </h3>
                      </div>
                      <figure>
                          <blockquote>
                              <p className="text-gray-800 dark:text-gray-300 lg:text-lg font-normal sm:text-xl">
                                  “I would like to commend the user-friendly interface of the Deskme platform. The design is intuitive,
                                  making it easy to navigate and locate the features I needed.
                                  The booking process was seamless, and I appreciated the clear instructions provided at each step.“
                              </p>
                          </blockquote>
                          <div className="mt-6">
                              <img src="https://hips.hearstapps.com/hmg-prod/images/gettyimages-1229892983-square.jpg?crop=1xw:1.0xh;center,top&resize=640:*" className="w-16 h-16 mx-auto rounded-full" />
                              <div className="mt-3">
                                  <span className="block text-gray-800 dark:text-gray-200 font-semibold">Elon Musk</span>
                                  <span className="block text-gray-600 dark:text-gray-400 text-sm mt-0.5">Founder of Tesla</span>
                              </div>
                          </div>
                      </figure>
                  </div>
          ...
          <span class="relative z-10 bg-neutral-50 dark:bg-neutral-900 dark:text-white px-6">Values</span>
          </span>

          <section className="bg-neutral-50 dark:bg-neutral-900">
            <div className="mx-auto max-w-screen-lg px-4 py-12 sm:px-6 md:py-16 lg:px-8">
              <div className="mx-auto max-w-3xl text-center">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-neutral-100 sm:text-4xl">Trusted by eCommerce Businesses</h2>

                <p className="mt-4 text-gray-500 dark:text-neutral-300 sm:text-xl">
                  At Deskme, we pride ourselves on being the trusted partner for eCommerce businesses of all sizes.
                  With years of experience in the industry, we understand the unique challenges and opportunities that 
                  online hotdesk booking face.
                </p>
              </div>
              ...
              <div className="mt-8 sm:mt-12">
                <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center">
                    ...
                    <dd className="text-4xl font-extrabold text-neutral-700 dark:text-neutral-300 md:text-5xl">250</dd>
                  </div>

                  <div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center">
                    <dt className="order-last text-lg font-medium text-gray-500">New Users</dt>

                    <dd className="text-4xl font-extrabold text-neutral-700 dark:text-neutral-300 md:text-5xl">10</dd>
                  </div>

                  <div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center">
                    <dt className="order-last text-lg font-medium text-gray-500">All Users</dt>

                    <dd className="text-4xl font-extrabold text-neutral-700 dark:text-neutral-300 md:text-5xl">400</dd>
                  </div>
                </dl>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
                <div className="relative z-10 lg:py-16">
                  <div className="relative h-64 sm:h-80 lg:h-full border-[1px] border-neutral-400 rounded">
                    <img
                      alt=""
                      src="https://images.pexels.com/photos/4412921/pexels-photo-4412921.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                      className="absolute inset-0 h-full w-full object-cover"
                    />
                  </div>
                </div>

                <div className="relative flex items-center bg-neutral-100 dark:bg-neutral-800 border-[1px] border-neutral-300">
                  <span className="hidden lg:absolute lg:inset-y-0 lg:-start-16 lg:block lg:w-16 lg:bg-neutral-100 dark:bg-neutral-800"></span>

                  <div className="p-8 sm:p-16 lg:p-24 mx-auto">
                    <h2 className="lg:text-2xl font-bold sm:text-3xl dark:text-white">
                      Upgrade your workspace with Deskme and experience the difference that thoughtful design and superior comfort can make.
                    </h2>

                    <p className="mt-4 text-gray-600 dark:text-neutral-300">
                      That’s why we’ve designed our desks to offer unparalleled comfort, ensuring you stay
                      focused and comfortable throughout your workday.
                    </p>

                    <a
                      href="#"
                      className="mt-8 inline-block rounded border border-neutral-900 bg-neutral-900 dark:border-neutral-500 dark:bg-neutral-400 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-neutral-700 focus:outline-none focus:ring active:text-neutral-700"
                    >
                      Get in Touch
                    </a>
                  </div>
          ...
          <span class="relative z-10 bg-neutral-50 dark:bg-neutral-900 dark:text-white px-6">Pricing</span>
          </span>
            ...
            <section className='py-14'>
              <div className="max-w-screen-lg mx-auto px-4 text-gray-600 md:px-8">
                  <div className='relative max-w-xl mx-auto sm:text-center'>
                      ...
                      <div className='mt-3 max-w-xl dark:text-neutral-300'>
                          <p>
                          ...
                          plans.map((item, idx) => (
                              <div key={idx} className={`relative flex-1 flex items-stretch flex-col rounded-xl border-2 mt-6 sm:mt-0 ${item.isMostPop ? "mt-10" : ""}`}>
                                  ...
                                  <div className="p-8 space-y-4 border-b">
                                      ...
                                      <div className='text-gray-800 dark:text-neutral-300 text-3xl font-semibold'>
                                          ${item.price} <span className="text-xl text-neutral-600 dark:text-neutral-400 font-normal">/mo</span>
                                      </div>
                                  ...
                                  <ul className='p-8 space-y-3'>
                                      <li className="pb-2 text-gray-800 dark:text-neutral-100 font-medium">
                                          <p>Features</p>
                                      </li>
                                      {
                                          item.features.map((featureItem, idx) => (
                                              <li key={idx} className='flex items-center gap-5 dark:text-neutral-300'>
                                                  <svg
                                                      xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='container -mt-10'>
            <div className="py-14">
              <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                  <h3 className="font-semibold text-lg text-neutral-700 dark:text-neutral-100 text-center">
                      Trusted by best companies around the world:
                  </h3>
                  <div className="mt-6">
                      <ul className="flex gap-x-10 gap-y-6 flex-wrap items-center justify-center md:gap-x-16">
                          {/* LOGO 1 */}
                        <li>
                          <svg className="w-36 dark:bg-white rounded-lg p-2" viewBox="0 0 163 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {/* LOGO 2 */}
                        <li>
                          <svg className="w-36 dark:bg-white rounded-lg p-2" viewBox="0 0 129 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {/* LOGO 3 */}
                        <li>
                          <svg className="w-36 dark:bg-white rounded-lg p-2" viewBox="0 0 135 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {/* LOGO 4 */}
                        <li>
                          <svg className="w-36 dark:bg-white rounded-lg p-2" viewBox="0 0 164 48" fill="none" xmlns="http://www.w3.org/2000/svg">
