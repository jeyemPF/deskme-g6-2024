        ...
        >
          ...
          <ul className="pt-2">
            {firstMenuItems.map((Menu, index) => (
              <li
                key={index}
                className={`text-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-300 dark:hover:text-black text-sm font-medium flex items-center gap-x-4 p-2 hover:bg-neutral-700 hover:text-white rounded-md cursor-pointer ${
                  Menu.gap && "mt-9"
                }`}
              >
                {Menu.icon}
          ...
          <ul className="flex flex-col lg:mt-60 sm:mt-44 ">
            ...
            <li className="text-neutral-700 text-sm font-medium flex items-center gap-x-4 p-2 hover:bg-neutral-700 hover:text-white rounded-md mt-9 cursor-pointer dark:text-neutral-300 dark:hover:bg-neutral-300 dark:hover:text-black">
              <MdSettings className="text-2xl" />
              <span className={`${!open && "hidden"} origin-left duration-200`}>
                Settings
              </span>
            </li>
            <li onClick={handleClick} className="text-neutral-700 text-sm font-medium flex items-center gap-x-4 p-2 mt-1 hover:bg-neutral-700 hover:text-white border-2 border-neutral-700 rounded-md cursor-pointer dark:text-neutral-300 dark:border-neutral-300 dark:hover:bg-neutral-300 dark:hover:text-black">
