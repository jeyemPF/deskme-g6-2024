      ...
      <header className="dark:bg-neutral-900 w-screen fixed bg-white p-2 border-b-[1px] border-gray-200 dark:border-neutral-500 dark:shadow-neutral-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 pl-2">
            ...
            <h1 className='font-extrabold md:text-xl sm:text-lg cursor-pointer text-neutral-700 dark:text-neutral-100'>DESKME</h1>
          </div>
          <div className="flex items-center md:space-x-4 sm:space-x-2 flex-row-reverse">
            <div className="flex flex-col md:pr-2 sm:pr-0">
              <span className="md:text-sm sm:text-xs font-medium text-gray-800 dark:text-neutral-100 ml-3">John Carlo Diga</span>
            ...
            <BellIcon className="h-7 w-7 text-neutral-800 rounded-full p-1 hover:bg-neutral-700 hover:text-white dark:text-neutral-100 dark:hover:bg-white dark:hover:text-neutral-700 cursor-pointer" />
