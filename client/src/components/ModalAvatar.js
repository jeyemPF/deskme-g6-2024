      ...
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="bg-white dark:bg-neutral-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <h2 className="text-lg font-medium text-gray-900 dark:text-neutral-300 text-center">Customize Profile</h2>
            <form className="mt-4 text-center">
              <div className="flex items-center justify-center mb-4">
                <div className="flex items-center justify-center w-24 h-24 rounded-full overflow-hidden border-2 border-black dark:border-neutral-300 avatar mx-auto">
              ...
              <label htmlFor="avatar-upload" className="items-center justify-center text-sm text-gray-600 hover:text-gray-900 dark:text-neutral-400 cursor-pointer">Change Avatar</label>
                <input type="file" id="avatar-upload" className="hidden" accept="image/*" onChange={handleAvatarChange} />
              <div className="mb-4 text-center">
                <label className="mt-2 block text-sm font-medium text-gray-700 dark:text-neutral-300">Edit name:</label>
          ...
          <div className="bg-gray-100 dark:bg-neutral-950 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button
              type="button"
