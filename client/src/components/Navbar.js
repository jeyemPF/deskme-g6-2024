    ...
    <div className="bg-white">
      <nav className="bg-white w-full start-0 dark:bg-neutral-900">
        <div className="flex flex-col-reverse items-center justify-between max-w-screen-navbar mx-auto">
          ...
          <h1 onClick={handleClickH1} className="flex w-full max-w-60 font-black lg:w-60 lg:p-12 lg:text-4xl md:w-52 md:p-8 md:text-2xl sm:w-32 sm:p-5 sm:text-xl cursor-pointer dark:text-white">DESKME</h1> 
            ...
            <div className="flex navbar:hidden gap-1">
              <button className="text-black text-xl pt-1"><Switcher /></button>
              <button className="text-black text-2xl pt-1 dark:text-white" onClick={toggleMenu}>
                <IoMenuSharp />
              </button>
            </div>
