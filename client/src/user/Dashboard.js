      ...
      <SidebarProvider>
        ...
        <Content>
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 mt-6">
                  ...
                  <div className="rounded-lg bg-white dark:bg-neutral-800 dark:border-neutral-700 border-[1px] border-neutral-100 shadow-sm lg:col-span-2 p-5">
                  <div className="flex justify-between items-center">
                    <h1 className='font-semibold pl-4 text-lg dark:text-neutral-100'>Available Desks:</h1>
                    <div className="relative w-60 max-w-md">
                        <input
                        type="text"
                        className="w-full dark:bg-neutral-800 dark:border-neutral-500 p-2 pr-10 pl-4 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-150 ease-in-out"
                    ...
                    <ol className="flex justify-center gap-1 mt-5 text-xs font-medium">
                      ...
                      <li>
                        <a
                          href="#"
                          className="inline-flex size-8 items-center justify-center dark:border-neutral-500 rounded border dark:bg-neutral-700 border-gray-100 bg-white text-gray-900 rtl:rotate-180"
                        >
